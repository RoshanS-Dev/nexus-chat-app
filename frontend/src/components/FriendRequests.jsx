  ...
  const UserCard = ({ user: candidate, onAction, actionType = 'send', isLoading = false, isDisabled = false }) => {
    ...
    if (actionType === 'send') {
      ...
      actionClasses = hasSent
        ...
        : 'bg-nexus-primary text-white hover:bg-nexus-secondary';
    ...
    <div className="flex flex-col h-full min-h-0 bg-white overflow-hidden">
      ...
      <div className="p-4 sm:p-6 border-b border-gray-100 shrink-0 space-y-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-nexus-primary/80 font-bold">
              Connection Hub
            </p>
        ...
        {activeTab === 'find' && (
          ...
          >
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-sm text-gray-700 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-nexus-primary/30 focus:border-transparent transition-all"
            />
          </motion.div>
        )}
      </div>
          ...
          {activeTab === 'find' ? (
            ...
            >
              {searchQuery.trim() === '' ? (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="rounded-2xl border border-dashed border-gray-200 bg-gradient-to-br from-nexus-primary/5 to-blue-50 p-8 text-center mt-8"
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-nexus-primary/10 rounded-2xl mb-4">
                    <UserPlus size={32} className="text-nexus-primary" />
                  </div>
                ...
                >
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-12 h-12 bg-nexus-primary/10 rounded-full mb-3">
                      <Loader size={24} className="text-nexus-primary animate-spin" />
                    </div>
            ...
            >
              {pending.length === 0 ? (
                ...
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-nexus-primary/10 rounded-2xl mb-4">
                    <Inbox size={32} className="text-nexus-primary" />
                  </div>
