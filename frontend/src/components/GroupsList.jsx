    ...
    <div className="flex flex-col h-full min-h-0 bg-white overflow-hidden">
      <div className="p-3 sm:p-4 border-b border-gray-100 flex items-center justify-between shrink-0">
        ...
        <button
          ...
          className="p-2 rounded-full bg-nexus-primary text-white hover:bg-nexus-primary-dark"
        >
          <Plus size={18} />
        </button>
      </div>
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="p-3 sm:p-4 border-b border-gray-100 space-y-3 bg-nexus-bg/50 shrink-0">
          <input
            type="text"
