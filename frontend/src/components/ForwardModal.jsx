        ...
        >
          ...
          <div className="p-4 border-b border-gray-100">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-nexus-primary/30"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-2">
            {loading ? (
              <div className="flex justify-center py-8">
                <div className="w-8 h-8 border-4 border-nexus-primary border-t-transparent rounded-full animate-spin" />
              </div>
            ) : filtered.length === 0 ? (
                ...
                {filtered.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors ${isSelected ? 'bg-nexus-primary border-nexus-primary text-white' : 'border-gray-300'}`}>
          ...
          <div className="p-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
            ...
            <button
              ...
              className="px-6 py-2 bg-nexus-primary text-white rounded-full font-medium text-sm disabled:opacity-50 transition-opacity hover:bg-nexus-primary-dark"
            >
