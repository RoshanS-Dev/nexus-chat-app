    ...
    <div className="h-full flex flex-col bg-white overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-4 sm:px-6 py-4 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 px-3 py-2 bg-nexus-primary text-white rounded-lg cursor-pointer hover:bg-nexus-secondary transition-colors text-sm font-medium">
                <Camera size={16} />
                Change Avatar
                <input
                  type="file"
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-nexus-primary/30"
            maxLength="50"
          />
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows="3"
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-nexus-primary/30 resize-none"
            maxLength="500"
          />
        ...
        <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              onChange={handleInputChange}
              className="w-4 h-4 rounded border-gray-300 text-nexus-primary cursor-pointer"
            />
      ...
      <div className="p-4 border-t border-gray-100 shrink-0 bg-gray-50">
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 py-3 bg-nexus-primary text-white rounded-lg hover:bg-nexus-secondary transition-colors font-semibold disabled:opacity-60 disabled:cursor-not-allowed"
        >
          <Save size={18} />
