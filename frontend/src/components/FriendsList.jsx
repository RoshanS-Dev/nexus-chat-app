      ...
      <div className="p-3 sm:p-4 border-b border-gray-100 shrink-0">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-nexus-bg rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-nexus-primary/20"
          />
        </div>
      </div>
                ...
                >
                  ...
                  <div className="flex gap-1 shrink-0">
                    <button
                      ...
                      className="p-2 rounded-full bg-nexus-primary text-white hover:bg-nexus-primary-dark transition-colors"
                      title="Message"
                    >
