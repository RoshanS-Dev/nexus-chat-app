...
const GroupDetails = ({ group, onClose, onSettingsClick }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white overflow-hidden">
      {/* Header */}
      <div className="relative bg-gradient-to-br from-nexus-primary to-nexus-secondary h-32 shrink-0">
        {onClose && (
          <button
            type="button"
            onClick={onClose}
                ...
                <div className="p-4 bg-nexus-primary/5 border border-nexus-primary/20 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 bg-nexus-primary text-white rounded hover:bg-nexus-secondary transition-colors"
                    >
                      <Copy size={14} />
                    </button>
                  </div>
                  ...
                  {WALLPAPERS.map((wp, idx) => (
                    <button
                      ...
                      className={`relative h-16 rounded-lg overflow-hidden border-2 transition-all ${
                        wallpaper === wp.value ? 'border-nexus-primary' : 'border-transparent'
                      }`}
                    >
                      {wp.value ? (
