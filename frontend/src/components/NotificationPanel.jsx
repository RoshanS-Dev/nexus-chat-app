      ...
      <div className="p-3 sm:p-4 border-b border-gray-100 flex items-center justify-between gap-2 shrink-0 min-w-0">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="text-xs text-nexus-primary font-medium flex items-center gap-1 shrink-0 whitespace-nowrap"
          >
            <CheckCheck size={14} />
            Mark all read
          </button>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
        {loading ? (
          <div className="flex justify-center py-12">
            <Loader className="animate-spin text-nexus-primary" size={24} />
          </div>
        ) : list.length === 0 ? (
