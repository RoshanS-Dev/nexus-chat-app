      ...
      <div className="lg:hidden flex flex-col border-b border-gray-200 bg-white safe-top">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <NexusLogo size="sm" showText={true} className="shrink-0" />
          </div>
        ...
        <div className="px-4 py-3 border-b border-gray-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-9 py-2.5 bg-nexus-bg border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-nexus-primary/30 focus:border-nexus-primary transition-all"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`flex-1 py-3 px-4 text-sm font-medium transition-colors border-b-2 ${
                activeTab === tab.id
                  ? 'text-nexus-primary border-nexus-primary'
