  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-white overflow-hidden">
      <div className="p-3 sm:p-4 border-b border-gray-100 shrink-0">
        ...
        <p className="text-xs text-gray-500 mt-0.5">Manage your Nexus account</p>
      </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-3 sm:p-4 space-y-3 sm:space-y-4">
        ...
        <div className="modern-card !p-4 space-y-3">
          <button
            ...
            className="w-full py-2.5 rounded-xl bg-nexus-primary text-white font-medium text-sm flex items-center justify-center gap-2 hover:bg-nexus-primary-dark transition-colors"
          >
            <ArrowRight size={16} />
            Edit Profile
          </button>
          ...
          {showPasswordForm && (
            ...
            >
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-nexus-primary text-white text-sm font-medium disabled:opacity-50"
              >
