...
const ModernLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-nexus-bg flex items-center justify-center p-4 overflow-x-hidden">
        ...
        <div className="hidden lg:flex flex-col justify-center items-center text-center p-8">
          ...
          <div className="space-y-4 text-gray-500 text-sm">
            <div className="flex items-center gap-3 justify-center">
              <span className="w-2 h-2 rounded-full bg-nexus-primary" />
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8 max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="flex items-center justify-end">
                <Link 
                  to="/forgot-password" 
                  className="text-sm font-medium text-nexus-primary hover:text-nexus-primary-dark transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 px-4 bg-nexus-primary hover:bg-nexus-primary-dark text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <Link
                to="/register"
                className="font-semibold text-nexus-primary hover:text-nexus-primary-dark transition-colors"
              >
                Create account
              </Link>
            </p>
