...
const OTPVerificationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-nexus-bg overflow-x-hidden flex flex-col">
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-8 w-full">
            <div className="text-center mb-6">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-nexus-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 sm:w-10 sm:h-10 text-nexus-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {email && (
                <p className="text-nexus-secondary font-semibold mt-1 text-sm break-all px-2">
                  {email}
                </p>
              )}
            </div>
            ...
            <div className="mt-5 text-center">
              ...
              <button
                ...
                className={`text-sm font-semibold ${
                  canResend
                    ? 'text-nexus-secondary hover:underline'
            ...
            <div className="mt-5 p-3 sm:p-4 bg-nexus-bg rounded-xl">
            ...
            <p className="mt-4 text-center text-sm text-gray-500">
              <Link to="/register" className="text-nexus-secondary font-medium hover:underline">
                Back to register
              </Link>
            </p>
          </div>
