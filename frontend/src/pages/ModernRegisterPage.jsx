  ...
  return (
    <div className="min-h-screen bg-nexus-bg overflow-x-hidden">
      <div className="min-h-screen grid lg:grid-cols-2">
        <div className="hidden lg:flex flex-col justify-center items-center bg-nexus-primary text-white p-12">
          <NexusLogo size="lg" className="mb-8 [&_span]:text-white" />
          <h1 className="text-3xl font-bold mb-3 text-center">Join NEXUS</h1>
          ...
          <div className="w-full max-w-md mx-auto my-4 sm:my-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-8 w-full">
              <div className="mb-5 sm:mb-6">
                ...
                <p className="text-gray-500 text-sm mt-1">Join NEXUS today</p>
              </div>
              ...
              <p className="mt-5 text-center text-sm text-gray-500">
                ...
                <Link to="/login" className="text-nexus-secondary font-semibold hover:underline">
