    ...
    <div className="min-h-screen bg-nexus-bg overflow-x-hidden">
      <div className="max-w-lg mx-auto w-full px-3 sm:px-4 py-4 sm:py-6 pb-nav lg:pb-6">
        <button type="button" onClick={() => navigate('/messages')} className="flex items-center text-gray-600 hover:text-gray-900 mb-3 sm:mb-4 text-sm font-medium">
          <ArrowLeft size={18} className="mr-2 shrink-0" /> Back to NEXUS
        </button>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-3 sm:space-y-4 -mt-10 sm:-mt-12">
            <div className="flex flex-col items-center">
              <div className="relative">
                ...
                <button type="button" onClick={() => fileInputRef.current?.click()} className="absolute bottom-0 right-0 bg-nexus-primary text-white p-2 rounded-full shadow">
                  <Camera size={16} />
                </button>
              </div>
              ...
              {uploadProgress > 0 && uploadProgress < 100 && (
                <div className="w-full max-w-[12rem] mt-3">
                  <div className="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full bg-nexus-primary transition-all" style={{ width: `${uploadProgress}%` }} />
                  </div>
